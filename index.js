            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message supprimer me concernant') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/king.jpg'},caption : `        💫 TERRA-BOT DELETED INFORMATION💫\n Message from @${msg.key.participant.split('@')[0]}​` , mentions : [msg.key.participant]},)
                                .then( () => {
  ...
  try {
        ...
        if (texte.includes('https://') && verifGroupe &&  yes  ) {
         ...
         console.log("lien detecté")
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('oklm boss'); return};
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by TERRA-MD .`;
    ...
    try {
        ...
        if (botMsg || baileysMsg) {
            ...
            if( verifAdmin || auteurMessage === idBot  ) { console.log('oklm boss'); return};
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://i.imgur.com/VshQK9L.jpeg';
    }
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `╔════◇◇◇═════╗
║Terrasaki🤭 guy's welcome to new(s) member(s)
║ *New(s) Member(s) :*
`;
...
${metadata.desc}\n\n> POWERED BY IGWE TECH INC.`;
         ...
         zk.sendMessage(
            ...
            if (group.author == metadata.owner || group.author ==  conf.NUMERO_OWNER + '@s.whatsapp.net' || group.author == decodeJid(zk.user.id) || group.author == group.participants[0]) { console.log('Cas de superUser oklm boss') ;return ;} ;
    ...
    async  function activateCrons() {
            ...
            for (let i = 0; i < crons.length; i++) {
              ...
              if (crons[i].mute_at != null) {
                ...
                cron.schedule(`${set[1]} ${set[0]} * * *`, async () => {
                  ...
                  zk.sendMessage(crons[i].group_id, { image : { url : './media/chrono.webp'} , caption: "Hello, it's time to close the group amigo GN." });
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ TERRA_MD connecting in your account...");
            }
            else if (connection === 'open') {
                console.log("✅ TERRA-MD connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("TERRA_MD by IGWETECH INCORPORATE installing cmds😇\n\n");
                ...
                fs.readdirSync(__dirname + "/commandes").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            ...
                            console.log(fichier + "Successfully installed TERRA-MD commands✔️");
                        }
                        catch (e) {
                ...
                console.log("TERRA_MD successfully connected✅");

                await activateCrons();
                
                if((conf.DP).toLowerCase() === 'yes') {     
                let cmsg = `TERRA_MD IS RUNNING NOW...
...
> THANK YOU FOR CHOOSING TERRA_MD.\n`;
                await zk.sendMessage("24160338758@s.whatsapp.net", { text: cmsg });
                }
            }
